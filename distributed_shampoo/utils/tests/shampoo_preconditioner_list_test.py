    ...
    class BaseShampooPreconditionerListTest(
        ...
        def test_adaptive_amortized_computation_frequency(self):
            ...
            with (
                mock.patch.object(
                    ...
                    matrix_functions,
                    "_eigh_eigenvalue_decomposition",
                    side_effect=[
        ...
        def test_raise_nan_and_inf_in_inv_factor_matrix_amortized_computation(
            ...
            for (
                ...
                self._amortized_computation_properties.invalid_amortized_computation_return_values
            ):
                with (
        ...
        def test_amortized_computation_failure_tolerance(self) -> None:
            ...
            fail = ValueError
            success = (
                self._amortized_computation_properties.valid_amortized_computation_return_value
            )
